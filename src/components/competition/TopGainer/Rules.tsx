...
const Rules = () => (
  <div className="px-5 py-9 lg:p-0">
    ...
    <ul className="mb-16 ml-5 list-disc space-y-6 text-b1">
      ...
      <li>
        <p>
          <span className="text-b1e">Competing Metrics: </span>Realized P/L
        </p>
      </li>
      <li>
        <p>
          <span className="text-b1e">Definition:</span> Realized P/L is the sum of funding payment and P/L from price change of a position.
          P/L from price change refers to the gain & loss from full close, partial close and liquidation of a position.
        </p>
      </li>
      <li>
        <p>
          <span className="text-b1e">Rules:</span> Rank from highest Realized P/L to lowest Realized P/L
        </p>
      </li>
      <li>
        <p>
