...
const PrizeComponent = () => {
  ...
  return (
    <div className={`${activeDropdown === 0 ? '' : 'hidden md:block'} w-full bg-black bg-opacity-30 px-0`}>
      <div className="bg-[#171833] md:bg-transparent">
        <div
          className="md:bg-[rgba(0, 0, 0, 0.3)] flex  w-full flex-col-reverse flex-wrap items-stretch
              justify-center bg-[url('/images/components/competition/backgrounds/gainers-colorful.svg')] bg-contain bg-no-repeat px-0 md:mb-9 md:rounded-md md:border md:border-white md:border-opacity-20
              md:bg-[url('/images/components/competition/backgrounds/first-section.svg')]  min-[984px]:flex-row">
          {/* <div
              ...
              > */}
          <div className="w-full flex-grow bg-[#0c0d20] md:bg-transparent min-[984px]:w-auto  min-[984px]:rounded-l-md">
            <CustomTable
          ...
          <div className="bg-linear-gradient w-full py-12 min-[984px]:w-[477px] min-[984px]:rounded-r-md min-[984px]:py-0">
