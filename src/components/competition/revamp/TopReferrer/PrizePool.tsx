...
import { $isShowMobileMyReferrerTeam, $isShowMobileRules } from '@/stores/competition';
    ...
    <div className="justify-center md:flex md:flex-col">
      <div className="relative mb-24 hidden md:block">
        <Image
          ...
          src="/images/components/competition/revamp/prize_topRefer_desktops.png"
          width={937}
          height={345}
          alt=""
        />
      ...
      <div className="relative overflow-clip md:hidden">
        <div className="flex flex-col items-center">
          <Image
            ...
            src="/images/components/competition/revamp/prize_topRefer_mobiles.png"
            width={600}
            height={300}
            alt=""
          />
          ...
          <div className="flex items-center justify-between">
            {isConnected ? (
              <div
                ...
                onClick={() => {
                  $isShowMobileMyReferrerTeam.set(true);
                }}>
