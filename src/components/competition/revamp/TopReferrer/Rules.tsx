...
const Rules = () => (
  <div className="px-5 py-9 lg:p-0">
    ...
    <ul className="mb-16 ml-5 list-disc space-y-6 text-b1">
      ...
      <li>
        <p>
          <span className="text-b1e">Competing Metrics: </span>Referees’ trading volume
        </p>
      </li>
      <li>
        <p>
          <span className="text-b1e">Definition:</span> The Referees’ trading volume is the total notional trading volume (open, add,
          partial close and full close would be counted) in WETH generated by all the referred users of each participant.
        </p>
      </li>
      <li>
        <p>
          <span className="text-b1e">Rules:</span> Rank from highest Referees’ trading volume to lowest Referees’ trading volume; referred
          users have to trade over <span className="text-b1e">5 WETH</span> to be eligible.
        </p>
      </li>
      <li>
        <p>
