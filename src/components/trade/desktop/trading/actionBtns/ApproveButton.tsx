...
function AddCollateralButton({
  ...
  const { write, isError, error, isLoading, isSuccess, txHash } = useApproveTransaction(approvalAmount);
  ...
  return <BaseButton isPending={isLoading} onClickButton={write} label="Approve" />;
}
