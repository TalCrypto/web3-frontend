...
function TabItems() {
  ...
  const handleClickTab = (e: React.MouseEvent<HTMLElement>, tab: number) => {
    ...
    const userProfileTab = document.querySelector('.userprofile_tabs');
    const scrollCenter = userProfileTab ? userProfileTab.scrollWidth / 2 : 0;
    const tabOffsetL = e.currentTarget.offsetLeft;
    userProfileTab?.scrollTo({
  ...
  return (
    <div className="">
      <div className="userprofile_tabs flex space-x-9 overflow-auto px-[20px] md:px-0">
        <TabIcon
          ...
          active={activeTab === 0}
          itemIndex={0}
          onClick={(e: React.MouseEvent<HTMLElement>) => handleClickTab(e, 0)}
        />
        <TabIcon
          ...
          active={activeTab === 1}
          itemIndex={1}
          onClick={(e: React.MouseEvent<HTMLElement>) => handleClickTab(e, 1)}
        />
        <TabIcon
          ...
          active={activeTab === 2}
          itemIndex={2}
          onClick={(e: React.MouseEvent<HTMLElement>) => handleClickTab(e, 2)}
        />
        <TabIcon
          ...
          active={activeTab === 3}
          itemIndex={3}
          onClick={(e: React.MouseEvent<HTMLElement>) => handleClickTab(e, 3)}
        />
      </div>
    </div>
  );
